...
rm submissions_processing_flow_trigger.zip

Write-Host "Creating new target dir"
mkdir target

Write-Host "Copying submissions_processing_flow_trigger.py to target dir"
cp .\submissions_processing_flow_trigger.py .\target\
...
$command = '"C:\Program Files\7-Zip\7z.exe" a submissions_processing_flow_trigger.zip .\target\*'
